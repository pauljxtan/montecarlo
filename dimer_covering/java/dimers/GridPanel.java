...
public class GridPanel extends JPanel {
            ...
            for (int j = 0; j < grid.width; j++) {
                ...
                if (dimer != null) {
                    g2.fill(new Ellipse2D.Double(
                        PANEL_MARGIN + (j + 1.0 - CELL_CIRC_RATIO) * cellWidth,
                    ...
                    g2.drawLine(
                        PANEL_MARGIN + (2*dimer.sites[0].y+1) * cellWidth / 2,
    ...
    public boolean hasNoDimer(Coordinate[] sites) {
        return grid.hasNoDimer(sites);
    }
